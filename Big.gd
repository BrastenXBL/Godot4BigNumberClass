class_name Big
extends RefCounted
# This Script has been modified to work with Godot 4.0.x. 
...
# Changed from const to var. Godot 4.0.x lacks Static variables 
...
func setThousandName(name):
	other.thousand_name = name
	pass


func setThousandSeparator(separator):
	other.thousand_separator = separator
	pass


func setDecimalSeparator(separator):
	other.decimal_separator = separator
	pass


func setPostfixSeparator(separator):
	other.postfix_separator = separator
	pass


func setReadingSeparator(separator):
	other.reading_separator = separator
	pass


func setDynamicDecimals(d):
	other.dynamic_decimals = bool(d)
	pass


func setSmallDecimals(d):
	other.small_decimals = int(d)
	pass


func setThousandDecimals(d):
	other.thousand_decimals = int(d)
	pass


func setBigDecimals(d):
